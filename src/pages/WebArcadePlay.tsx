...
import { ArrowLeft, ExternalLink, Loader2, Maximize2, RotateCcw } from "lucide-react";
...
const WebArcadePlay = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-background">
      {/* Top bar */}
      <header className="flex items-center gap-2 px-3 py-2 border-b border-border/60 bg-background/95 backdrop-blur">
        <button
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10px] text-muted-foreground truncate">{game.category} · Web Arcade</p>
        </div>
        <Button
          size="icon"
          variant="ghost"
