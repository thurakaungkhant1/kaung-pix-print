            ...
            >
              ...
              <div className="flex items-center gap-2">
                <a
                  ...
                  className="h-11 px-3 rounded-2xl bg-[#229ED9]/10 border border-[#229ED9]/30 flex items-center gap-2 hover:bg-[#229ED9]/20 transition-colors"
                >
                  <svg viewBox="0 0 24 24" className="h-6 w-6 text-[#229ED9] fill-current shrink-0" aria-hidden="true">
                  ...
                  <span className="text-xs font-semibold text-[#229ED9] whitespace-nowrap">Join Telegram</span>
                </a>
